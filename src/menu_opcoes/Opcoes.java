...
public class Opcoes {
	...
	/**
	 * enquanto o usuario nao digitar um numero válido, continua repetindo até que coloque uma opcao válida 
	 */
	public void verificarOqueForDigitado() {
		...
		while (continuarTry) {
			...
			} catch (InputMismatchException erroDeInput) { // Value out of range / RuntimeException /
